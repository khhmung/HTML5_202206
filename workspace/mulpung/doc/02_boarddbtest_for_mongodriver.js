...
// todo1 을 비동기함수로 만들어준다.
// 내부의 insert는 동기방식으로 호출하면 콜백함수를 작성하지 않아도 되어 콜백헬에서 벗어날 수 있다.
...
async function todo8(){
  console.log('TODO 8. 게시물 수정(3번 게시물의 내용 수정)');
	return await db.board.updateOne({no : 3}, {$set : {content : '내용 수정'}});
}
